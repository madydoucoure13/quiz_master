                  ...
                  child: ClipPath(
                    ...
                    child: Container(
                      ...
                      color: const Color.fromARGB(
                          255, 243, 201, 33), // Couleur de la barre info user
                    ),
                  ),
                ),
                Container(
              ...
              (BuildContext context, int index) {
                ...
                return InkWell(
                  onTap: () {
                    setState(() {
                      selectedItemIndex =
                          index; // Met à jour l'élément sélectionné
                    });
                  },
                  child: Container(
                    margin: const EdgeInsets.symmetric(
                        horizontal: 10.0,
                        vertical: 5.0), // Espacement autour de l'élément
                      ...
                      border: Border(
                        ...
                        top: BorderSide(
                          ...
                          color: index == selectedItemIndex
                              ? Colors.blue
                              : Colors
                                  .transparent, // Bordure bleue pour l'élément sélectionné, sinon transparente
                        ),
                        right: BorderSide(
                          width: 2.0,
                          color: index == selectedItemIndex
                    ...
                    child: ListTile(
                      title: Text(
                        ...
                        style: TextStyle(
                          color: index == selectedItemIndex
                              ? Colors.blue
                              : Colors
                                  .black, // Texte bleu pour l'élément sélectionné, sinon noir
                        ),
                      ),
                      subtitle: Text(
                      ...
                      trailing: Container(
                        padding: const EdgeInsets.all(
                            6.0), // Espacement autour de l'icône réduite
                        decoration: const BoxDecoration(
                          shape: BoxShape.circle,
                            ...
                            showDialog(
                              ...
                              builder: (context) {
                                return AlertDialog(
                                  ...
                                  content:
                                      Text('Voulez-vous supprimer ce quiz ?'),
                                  actions: <Widget>[
                                    TextButton(
                                      onPressed: () {
